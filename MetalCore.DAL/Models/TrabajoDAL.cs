...
        public TrabajoObj ConsultarUTrabajoEspecifico(int idTrabajo)
        {
            ...
            using (var context = new DD_METALCOREEntities())
            {
                try
                {
                    ...
                    resultado.Nombre = datos.Empleado.nombre;
...
        public bool VerifiStockActua(int Cantidad, int idProducto, int idMaterial)
        ...
        public UsuarioObj ConsultarEmpleadoAcargo(int idUsuario)
        {
        ...
        {
            List<MaterialesOBJ> listaMaterialesXTrabajo = new List<MaterialesOBJ>();
        ...
        {
            List<TrabajoObj> listaPDF = new List<TrabajoObj>();
            ...
            using (var contex = new DD_METALCOREEntities())
            {
                try
                {
                    ...
                    foreach (var item in datos)
                    {
                        ...
                        listaPDF.Add(new TrabajoObj
                        {
                            IdTrabajo = item.idTrabajo,
                            NombreUsuario = nombreUsu.nombre,
                            NombreCliente = item.nombreCliente,
                            Fecha = item.fecha.Value,

...
namespace SB_Admin.Controllers
{
    public class UsuarioController : Controller
    {
        ...
        public ActionResult Consultar()
        {
            ...
            {
                LogModel.LogError("Modulo: Usuario. Mensaje: Error al Consultar Usuarios: " + ex.Message.ToString());
        ...
        public ActionResult CrearUsuarioFrm()
        {
            ...
            catch (Exception ex)
            {
                ...
                LogModel.LogError("Modulo: Usuario. Mensaje: Error al Crear Usuario Formulario: " + ex.Message.ToString());
        ...
        public ActionResult RegistrarUsuario(UsuarioObj usuario)
        {
            ...
            {
                LogModel.LogError("Modulo: Usuario. Mensaje: Error al Registrar Usuario: " + ex.Message.ToString());
        ...
        public ActionResult ModificarUsuarioForm(int idUsuario)
        {
            ...
            {
                LogModel.LogError("Modulo: Usuario. Mensaje: Error al Modificar Usuario Formulario: " + ex.Message.ToString());
        ...
        public ActionResult ActuaUsuario(UsuarioObj Actua)
        {
            ...
            {
                LogModel.LogError("Modulo: Usuario. Mensaje: Error al Actualizar Usuario: " + ex.Message.ToString());

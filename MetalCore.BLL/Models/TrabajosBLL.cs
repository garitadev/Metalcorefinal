...
namespace MetalCore.BLL.Models
{
    public class TrabajosBLL
    {
        ...
        {
            TrabajoDAL DAL = new TrabajoDAL();
            return (DAL.ConsultarMaterialesXTrabajo(idTrabajo));
        }
        ...
        public TrabajoObj RegistrarTrabajo(TrabajoObj obj)
        {
            ...
            UsuarioObj empleado = DAL.ConsultarEmpleadoAcargo(obj.IdUsuario);
            emailBLL.TrajaboAsignadoPlantilla(empleado, obj);
        ...
        public TrabajoObj EnviarEmailTrabajo(TrabajoObj obj)
        {
            TrabajoDAL DAL = new TrabajoDAL();
        ...
        {
            TrabajoDAL DAL = new TrabajoDAL();
            return (DAL.PdfConsulta());
        }

        public List<TrabajoObj> ConsultarUTrabajoPDF(int idUsuario)
        {
            TrabajoDAL DAL = new TrabajoDAL();
            return (DAL.ConsultarUTrabajoPDF(idUsuario));
        }
